...
Функционал: создание 10 позиций справочника Номенклатура

Как Тестировщик я хочу
создать 10 позиций номенклатуры
чтобы протестировать работы циклов   

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: создание 10 позиций справочника Номенклатура
